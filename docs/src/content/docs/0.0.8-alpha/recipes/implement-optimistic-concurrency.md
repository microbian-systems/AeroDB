...
slug: 0.0.8-alpha/recipes/implement-optimistic-concurrency
---
...
* [API: ConcurrencyException](/0.0.8-alpha/api/AeroDB.ConcurrencyException)
* [API: IVersioned](/0.0.8-alpha/api/AeroDB.IVersioned)
