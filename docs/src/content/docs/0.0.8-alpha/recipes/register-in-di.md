...
slug: 0.0.8-alpha/recipes/register-in-di
---
...
* [Configuration](/0.0.8-alpha/getting-started/configuration/)
* [Integrations: ASP.NET Identity](/0.0.8-alpha/integrations/aspnet-identity/)
