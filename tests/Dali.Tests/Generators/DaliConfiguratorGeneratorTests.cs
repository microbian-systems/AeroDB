...
/// See <c>Dali.Tests.DaliConfiguratorGeneratorTests</c> for the core scenario tests.
/// </summary>
...
public static class StaticConfigurator : Dali.IConfigureDali
{
    public static void Configure(Dali.StoreOptions options) { }
}

public class InstanceConfigurator : Dali.IConfigureDali
{
...
public class GenericConfigurator<T> : Dali.IConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}

public class SimpleConfigurator : Dali.IConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}
";
...
class InternalConfigurator : Dali.IConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}
";
...
public class Outer
{
    private class PrivateConfigurator : Dali.IConfigureDali
    {
        public void Configure(Dali.StoreOptions options) { }
    }

    public class PublicConfigurator : Dali.IConfigureDali
    {
        public void Configure(Dali.StoreOptions options) { }
    }
}
...
public class MyGlobalConfigurator : Dali.IGlobalConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}
";
...
public class TypedConfigurator : Dali.IConfigureDali<int>
{
    public void Configure(Dali.StoreOptions options) { }
}
";
...
public class DualConfigurator : Dali.IConfigureDali, Dali.IAsyncConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
...
public class SyncCfg : Dali.IConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}

public class GlobalCfg : Dali.IGlobalConfigureDali
{
    public void Configure(Dali.StoreOptions options) { }
}

public class AsyncCfg : Dali.IAsyncConfigureDali
{
    public Task ConfigureAsync(Dali.StoreOptions options, CancellationToken ct) => Task.CompletedTask;
}
";
