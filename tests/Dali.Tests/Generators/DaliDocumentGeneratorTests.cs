...
{
    /// <summary>
    /// Minimal inline definitions for Dali types that the generator discovers
    /// via <c>GetTypeByMetadataName</c>. These are defined inline because the
    /// real <c>Dali</c> assembly is excluded from compilation references to
...
";
    ...
    /// C# source snippets combined with the inline Dali type definitions.
    /// </summary>
...
";
    ...
    {
        var source = @"
public class MyEntity : Dali.Entity<long>
{
...
";
    ...
    {
        var source = @"
public class VersionedDoc : SurrealDb.Net.Models.Record, Dali.IVersioned
{
...
";
    ...
    {
        var source = @"
public class FullEntity : Dali.Entity<long>, Dali.IVersioned
{
    public string? TenantId { get; set; }
    public long Version { get; set; }
