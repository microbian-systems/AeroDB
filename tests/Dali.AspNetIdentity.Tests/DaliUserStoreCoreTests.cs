...
public class DaliUserStoreCoreTests
{
    // ── Helpers ───────────────────────────────────────────────────────
    ...
    public async Task DeleteAsync_ShouldReturnSuccess_AndDeleteAssociatedRecords()
    {
        ...
        // Mock claim records
        var claims = new List<DaliUserClaim>
        {
        ...
        // Mock login records
        var logins = new List<DaliUserLogin>
        {
        ...
        // Mock token records
        var tokens = new List<DaliUserToken>
        {
        ...
        var passkeys = new List<DaliUserPasskey>
        {
            new() { Id = "p1", UserId = "user-1", CredentialId = [1, 2, 3] }
        };
        var passkeyQueryable = CreateMockQueryable(passkeys);
        session.Query<DaliUserPasskey>().Returns(passkeyQueryable);
