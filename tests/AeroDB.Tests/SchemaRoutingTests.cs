...
public class SchemaRoutingTests
{
    ...
    public async Task GetSchemaTarget_returns_null_database_for_default_schema()
    {
        ...
        var (db, table) = MetadataDispatch.GetSchemaTarget(typeof(DefaultEntity), options.Schema);
        db.ShouldBeNull();
    ...
    public async Task GetSchemaTarget_returns_configured_database()
    {
        ...
        var (db, table) = MetadataDispatch.GetSchemaTarget(typeof(SalesOrder), options.Schema);
        db.ShouldBe("sales");
    ...
    public async Task GetSchemaTarget_returns_correct_table_for_entity_without_mapping()
    {
        ...
        var (db, table) = MetadataDispatch.GetSchemaTarget(typeof(Person), options.Schema);
        db.ShouldBeNull();
    ...
    public async Task Query_on_schema_database_routes_to_correct_forked_session()
    {
        ...
        var schemaDb = MetadataDispatch.GetSchemaTarget(typeof(SalesOrder), internalSession.StoreOptions.Schema).Database;
