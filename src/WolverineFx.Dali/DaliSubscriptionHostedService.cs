...
internal class DaliSubscriptionHostedService : IHostedService, IAsyncDisposable
{
    ...
    private sealed class DaliSubscriptionController : ISubscriptionController
    {
        ...
        public Task RecordDeadLetterEventAsync(IEvent evt, Exception ex)
        {
...
/// </summary>
internal sealed class DaliEnvelopeEvent : IEvent
{
    ...
    IReadOnlyList<EventTag>? IEvent.Tags => _tags?.AsReadOnly();
    ...
    public Func<IEvent, T> CreateAggregateIdentitySource<T>()
    {
