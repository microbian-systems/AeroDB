...
/// <br/>
/// <b>Existing AeroDB.Sable API:</b> AeroDB.Sable already achieves the same capabilities through:
/// <list type="bullet">
...
/// </summary>
/// <remarks>
/// In AeroDB.Sable, <see cref="ITenantQueryOperations"/> is implemented by the store
