...
namespace AeroDB.Sable;
    ...
    /// AeroDB.Sable's functions (130+) are simpler: <c>MethodCallExpression → string</c>. A type-based
    ...
    private bool TryRelationshipPath(MemberExpression member, out string path)
    {
        ...
        if (relationship is null)
        {
            throw new NotSupportedException(
                ...
                $"The member '{root.Type.Name}.{rootMember.Member.Name}' is not configured as an AeroDB.Sable relationship.");
        }
