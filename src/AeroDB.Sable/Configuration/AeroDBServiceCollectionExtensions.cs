...
/// <summary>
/// Extension methods for registering AeroDB.Sable services with the DI container.
/// </summary>
public static class AeroDBServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Registers AeroDB.Sable using a Marten-compatible service-provider options factory.
    /// </summary>
    ...
    /// <summary>
    /// Registers a secondary AeroDB.Sable <see cref="IDocumentStore"/> as a keyed scoped service,
