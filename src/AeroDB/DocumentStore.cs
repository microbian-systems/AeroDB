...
public class DocumentStore : IDocumentStore, ISessionFactory
{
    ...
    public async Task InitializeAsync(CancellationToken ct = default)
    {
        ...
        _logger.LogInformation("Initializing AeroDB store: Endpoint={Endpoint}, ns={Namespace}, db={Database}",
        ...
        _logger.LogInformation("AeroDB store initialized successfully: ns={Namespace}, db={Database}", ns, db);
