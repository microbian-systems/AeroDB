...
/// <summary>
/// Extension methods for registering AeroDB health checks with ASP.NET Core.
/// </summary>
public static class AeroDBHealthCheckExtensions
{
    /// <summary>
    /// Adds a health check for the AeroDB async daemon.
    ...
    /// <param name="name">The health check registration name (default: "AeroDB-daemon").</param>
