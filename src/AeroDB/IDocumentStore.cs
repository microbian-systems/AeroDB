...
/// <summary>The primary entry point for the AeroDB document store. Provides access to query sessions, document sessions, event store, background daemon, and advanced SDK features.</summary>
